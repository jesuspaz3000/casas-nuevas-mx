...
export function AppointmentEditDialog({ open, appointment, onClose, onUpdated }: Props) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center sm:px-4">
            ...
            <div className="relative bg-white dark:bg-gray-900 rounded-t-2xl sm:rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800 w-full sm:max-w-lg sm:mx-auto flex flex-col max-h-[95vh] sm:max-h-[90vh]">
                {/* Header */}
                ...
                <form onSubmit={handleSubmit} noValidate className="overflow-y-auto flex-1">
                    ...
                    {/* Footer */}
                    <div className="flex flex-col gap-3 px-4 sm:px-6 py-4 border-t border-gray-100 dark:border-gray-800 flex-shrink-0">
                        <Button
                            type="button"
                            variant="secondary"
                            fullWidth
