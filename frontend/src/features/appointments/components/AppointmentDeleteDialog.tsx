...
export function AppointmentDeleteDialog({ open, loading, appointment, onConfirm, onCancel }: Props) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
            ...
            <div className="relative bg-white dark:bg-gray-900 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800 w-full max-w-sm p-6 flex flex-col items-center gap-4">
                ...
                <div className="text-center">
                    <h2 className="text-base font-semibold text-gray-900 dark:text-white">¿Eliminar cita?</h2>
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                        La cita de{" "}
                        <span className="font-medium text-gray-700 dark:text-gray-200">{appointment.clientName}</span>{" "}
                        para ver{" "}
                        <span className="font-medium text-gray-700 dark:text-gray-200">{appointment.propertyTitle}</span>{" "}
